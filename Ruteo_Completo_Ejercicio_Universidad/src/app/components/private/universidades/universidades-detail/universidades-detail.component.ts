...
@Component({
  selector: 'app-universidades-detail',
  templateUrl: './universidades-detail.component.html',
  styleUrls: ['./universidades-detail.component.css']
})
export class UniversidadesDetalleComponent implements OnInit {
