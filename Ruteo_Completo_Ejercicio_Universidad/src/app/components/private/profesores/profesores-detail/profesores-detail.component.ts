...
@Component({
  selector: 'app-profesores-detail',
  templateUrl: './profesores-detail.component.html',
  styleUrls: ['./profesores-detail.component.css']
})
export class ProfesoresDetalleComponent implements OnInit {
